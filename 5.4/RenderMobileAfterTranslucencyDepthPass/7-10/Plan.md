...
我现在的做法我的理解是我这样子写入Depth仍然会绑定颜色相关VS/PS，能否绑定移动端延迟渲染绑定的DepthPass Shader？或者根据我的需求给出合适的方案，我这样做只是为了考虑性能问题
...
请综合考虑我的方案是否为好的方案，或者是否有其他的好的方案？将分析结果存储到Engine\Docs中，给出的分析中或建议中要给出代码文件及行号位置，给出代码片段佐证，你给出的所有分析中都要能验证找到代码验证
