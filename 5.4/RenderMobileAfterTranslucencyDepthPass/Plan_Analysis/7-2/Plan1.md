...
行号不用做出太多纠正，代码只要在正确的文件中，正确的作用域即可，以下是我的引擎修改方案，结合当前工程源码对此方案进行分析
...
我现在的做法我的理解是我这样子写入Depth仍然会绑定颜色相关VS/PS

我的想法是根据Engine/Source/Runtime/Renderer/Private/DepthRendering.cpp:1230创建一个类似的构建Processor的函数CreateMobileDepthPassProcessor，
...
对Engine/Source/Runtime/Renderer/Private/MobileShadingRenderer.cpp:377和Engine/Source/Runtime/Renderer/Private/SceneRendering.cpp:4196等相关代码通过我创建的DepthPassProcess,
